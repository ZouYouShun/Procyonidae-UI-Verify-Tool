...
import { BrowserSettingsViewsAccount } from '@procyonidae/browser/settings/views/account';
import { BrowserSettingsViewsSnippets } from '@procyonidae/browser/settings/views/snippets';
